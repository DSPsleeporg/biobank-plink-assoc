...
configure_file( ${CMAKE_CURRENT_SOURCE_DIR}/../zlib-1.2.11/zlib.pc.cmakein
		${ZLIB_PC} @ONLY)
configure_file(	${CMAKE_CURRENT_SOURCE_DIR}/../zlib-1.2.11/zconf.h.cmakein
...
if(NOT MINGW)
    set(ZLIB_DLL_SRCS
        ../zlib-1.2.11/win32/zlib1.rc # If present will override custom build rule below.
    )
endif()

if(CMAKE_COMPILER_IS_GNUCC)
    if(ASM686)
        set(ZLIB_ASMS ../zlib-1.2.11/contrib/asm686/match.S)
    elseif (AMD64)
        set(ZLIB_ASMS ../zlib-1.2.11/contrib/amd64/amd64-match.S)
    endif ()
...
file(READ ${CMAKE_CURRENT_SOURCE_DIR}/../zlib-1.2.11/zlib.h _zlib_h_contents)
