...
public:
    ...
    static std::pair<int, int> find_SNP_idx_range(const Genotype_map_flags& genotype_map_flags, const std::string& line);
    ...
    static std::pair<int, int> find_base_idx_range(const Genotype_map_flags& genotype_map_flags, const std::string& line,const int base_choice_idx);//
    //Returns pair of SNP idx, and vector of 4 states in original form.
    static std::pair<std::string, std::vector<std::string>> parse_line_for_original(const Genotype_map_flags& genotype_map_flags, const std::string& line);
